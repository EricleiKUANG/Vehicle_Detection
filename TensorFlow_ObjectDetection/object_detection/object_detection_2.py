...
PATH_TO_LABELS = os.path.join('/nfs/private/tfmodels/research/My_object_detection_Faster_rcnn_resnet101v2', 'BDD100k_label_map.pbtxt')
...
print(str(now) + " : count is : " + len(images))
start = timer()
  # Actual detection.
